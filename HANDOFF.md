...
Keep this work on a Draft PR after local validation. Do not mark Ready or merge until the user explicitly approves those steps. GitHub Actions remain unsafe for metered usage; use `[skip ci]` and local validation, and cancel any accidentally triggered run immediately. See `docs/RINKA_PHASE11_GEOMETRIC_POSTER_ABSTRACTION.md`.
